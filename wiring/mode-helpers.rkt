...
(define (wire-timeouts! settings)
  ...
  ;; v1.00.05 W1 (#9393): wire per-model sse-read timeouts
  ;; (timeouts.models.<model>.sse-read) into current-model-sse-read-timeouts.
...
;; NOTE (v0.95.21): User-scope and auto-reflection wiring moved to run-modes.rkt
;; production path. This function is not called from production code.
