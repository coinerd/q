...
(define es-tests
  (test-suite "Event Structs Package Decomposition"
    ...
    (test-case "turn-events: construction and inheritance"
      (define tse (make-turn-start-event #:session-id "s1"
                                          #:turn-id "t1"
                                          #:timestamp 1000
                                          #:model "gpt-4"
                                          #:provider "openai"))
    ...
    (test-case "message-events: construction and inheritance"
      (define mse (make-message-start-event #:session-id "s1"
                                             #:turn-id "t1"
                                             #:timestamp 1000
                                             #:role "assistant"
                                             #:model "gpt-4"))
    ...
    (test-case "tool-events: tool-call-event and per-tool inheritance"
      (define tce (make-tool-call-event #:session-id "s1"
                                         #:turn-id "t1"
                                         #:timestamp 1000
                                         #:tool-name "bash"
      ...
      ;; Per-tool: bash
      (define bce (make-bash-tool-call-event #:session-id "s1"
                                              #:turn-id "t1"
                                              #:timestamp 1000
                                              #:command "ls -la"
                                              #:timeout 30
      ...
      ;; Per-tool: edit
      (define ece (make-edit-tool-call-event #:session-id "s1"
                                              #:turn-id "t1"
                                              #:timestamp 1000
                                              #:path "/tmp/test.rkt"
                                              #:edits '()
    ...
    (test-case "tool-events: tool-result-event"
      (define tre (make-tool-result-event #:session-id "s1"
                                           #:turn-id "t1"
                                           #:timestamp 1000
                                           #:tool-call-id "tc-1"
                                           #:content "output"
    ...
    (test-case "provider-events: construction and inheritance"
      (define pre (make-provider-request-event #:session-id "s1"
                                                #:turn-id "t1"
                                                #:timestamp 1000
                                                #:model "gpt-4"
                                                #:provider "openai"))
    ...
    (test-case "session-events: session lifecycle"
      (define sse (make-session-start-event #:session-id "s1"
                                             #:turn-id "t1"
                                             #:timestamp 1000
                                             #:model "gpt-4"))
      ...
      (define ie (make-input-event #:session-id "s1"
                                    #:turn-id "t1"
                                    #:timestamp 1000
                                    #:input-type "text"
                                    #:content "hello"))
      ...
      (define mse (make-model-select-event #:session-id "s1"
                                            #:turn-id "t1"
                                            #:timestamp 1000
                                            #:model "gpt-4"
                                            #:provider "openai"))
      ...
      (define ase (make-agent-start-event #:session-id "s1"
                                           #:turn-id "t1"
                                           #:timestamp 1000
                                           #:model "gpt-4"))
      ...
      (define ce (make-context-event #:session-id "s1"
                                      #:turn-id "t1"
                                      #:timestamp 1000
                                      #:token-count 1000
                                      #:window-size 4000))
