...
(test-case "test-export-formats: checks block 13"
...
(test-case "test-export-formats: checks block 12"
...
(test-case "test-export-formats: checks block 11"
...
(test-case "test-export-formats: checks block 9"
...
(test-case "test-export-formats: checks block 8"
...
(test-case "test-export-formats: checks block 7"
...
(test-case "test-export-formats: checks block 6"
...
(test-case "test-export-formats: checks block 5"
  (check-true (hash-has-key? sess 'entries) "json: has entries")
  (check-true (hash-has-key? sess 'exported_at) "json: has exported_at")
  (check-true (hash-has-key? sess 'export_format_version) "json: has export_format_version")
  (check-equal? (hash-ref sess 'export_format_version) "0.5.3" "json: export format version string")
...
(test-case "test-export-formats: checks block 4"
...
(test-case "test-export-formats: checks block 3"
...
(test-case "test-export-formats: checks block 2"
