...
(test-case "make-tool without prompt-guidelines defaults to #f"
  (define t (make-tool "mytool" "A test tool" (hasheq 'type "object" 'properties (hasheq)) void))
  (check-false (tool-prompt-guidelines t)))

(test-case "set-active-tools! filters list-tools"
  (define reg (make-tool-registry))
  (register-tool! reg (make-tool "tool-a" "A" (hasheq 'type "object" 'properties (hasheq)) void))
  (register-tool! reg (make-tool "tool-b" "B" (hasheq 'type "object" 'properties (hasheq)) void))
  (register-tool! reg (make-tool "tool-c" "C" (hasheq 'type "object" 'properties (hasheq)) void))
...
(test-case "tool->jsexpr includes promptGuidelines when set"
  (define t (make-tool "mytool" "desc" (hasheq 'type "object" 'properties (hasheq)) void #:prompt-guidelines "Use carefully"))
...
(test-case "tool->jsexpr omits promptGuidelines when #f"
  (define t (make-tool "mytool" "desc" (hasheq 'type "object" 'properties (hasheq)) void))
  (define js (tool->jsexpr t))
