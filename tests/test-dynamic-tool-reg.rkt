...
(test-case "set-active-tools! filters list-tools"
  ...
  (register-tool!
   reg
   (make-tool "tool-a" "A" (hasheq 'type "object" 'properties (hasheq) 'required (list)) void))
  (register-tool!
   reg
   (make-tool "tool-b" "B" (hasheq 'type "object" 'properties (hasheq) 'required (list)) void))
  (register-tool!
   reg
   (make-tool "tool-c" "C" (hasheq 'type "object" 'properties (hasheq) 'required (list)) void))
...
(test-case "tool->jsexpr includes promptGuidelines when set"
  (define t
    (make-tool "mytool"
               ...
               (hasheq 'type "object" 'properties (hasheq) 'required (list))
               void
               #:prompt-guidelines "Use carefully"))
...
(test-case "tool->jsexpr omits promptGuidelines when #f"
  (define t
    (make-tool "mytool" "desc" (hasheq 'type "object" 'properties (hasheq) 'required (list)) void))
  (define js (tool->jsexpr t))
