...
;; Unlike the frozen v1.00.29 artifacts elsewhere in this file, the tier-ownership
;; matrix is a CURRENT-TREE drift check: it must describe the test families that
