...
(define (make-ext-dir base name)
  ...
  (make-directory* dir)
  (call-with-output-file (build-path dir "main.rkt") (lambda (p) (displayln "#lang racket/base" p)))
  dir)
    ...
    (test-case "restore extension moves back and clears quarantined state"
      (with-temp-quarantine-dir
       (lambda ()
         ...
         (make-directory* src-dir)
         (call-with-output-file (build-path src-dir "main.rkt") (lambda (p) (displayln "# test" p)))
