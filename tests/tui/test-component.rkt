...
(define-test-suite
 ...
 (test-case "component-invalidate! clears cache"
   (define comp
     (make-q-component (lambda (st w) (list (styled-line (list (styled-segment "x" '())))))
                       #:id 'test))
 ...
 (test-case "component-compose concatenates multiple components"
   (define comp-a
     (make-q-component (lambda (st w) (list (styled-line (list (styled-segment "A" '()))))) #:id 'a))
   (define comp-b
     (make-q-component (lambda (st w) (list (styled-line (list (styled-segment "B" '()))))) #:id 'b))
 ...
 (test-case "component wrapping render-status-bar"
   ...
   (define status-comp
     (make-q-component (lambda (st w) (list (render-status-bar st w))) #:id 'status-bar))
