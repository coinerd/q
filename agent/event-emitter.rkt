...
;; Auto-derived from the *-event-fields constants generated by define-typed-event.
(define (get-struct-field-names name)
  (case name
    [(message-start-event) message-start-event-fields]
    [(message-update-event) message-update-event-fields]
    [(message-end-event) message-end-event-fields]
    [(provider-request-event) provider-request-event-fields]
    [(provider-response-event) provider-response-event-fields]
    [(model-stream-delta-event) model-stream-delta-event-fields]
    [(model-stream-thinking-event) model-stream-thinking-event-fields]
    [(model-stream-completed-event) model-stream-completed-event-fields]
    [(session-start-event) session-start-event-fields]
    [(session-shutdown-event) session-shutdown-event-fields]
    [(input-event) input-event-fields]
    [(model-select-event) model-select-event-fields]
    [(agent-start-event) agent-start-event-fields]
    [(agent-end-event) agent-end-event-fields]
    [(turn-cancelled-event) turn-cancelled-event-fields]
    [(context-event) context-event-fields]
    [(tool-execution-start-event) tool-execution-start-event-fields]
    [(tool-execution-update-event) tool-execution-update-event-fields]
    [(tool-execution-end-event) tool-execution-end-event-fields]
    [(tool-call-event) tool-call-event-fields]
    [(tool-result-event) tool-result-event-fields]
    [(bash-tool-call-event) bash-tool-call-event-fields]
    [(edit-tool-call-event) edit-tool-call-event-fields]
    [(write-tool-call-event) write-tool-call-event-fields]
    [(read-tool-call-event) read-tool-call-event-fields]
    [(grep-tool-call-event) grep-tool-call-event-fields]
    [(find-tool-call-event) find-tool-call-event-fields]
    [(custom-tool-call-event) custom-tool-call-event-fields]
    [(turn-start-event) turn-start-event-fields]
    [(turn-end-event) turn-end-event-fields]
    [(auto-retry-event) auto-retry-event-fields]
    [(compaction-event) compaction-event-fields]
    [(injection-event) injection-event-fields]
    [(model-request-blocked-event) model-request-blocked-event-fields]
    [(message-blocked-event) message-blocked-event-fields]
    [(assistant-message-completed-event) assistant-message-completed-event-fields]
    [(stream-completed-event) stream-completed-event-fields]
    [(stream-delta-event) stream-delta-event-fields]
    [(stream-tool-call-delta-event) stream-tool-call-delta-event-fields]
    [(stream-thinking-event) stream-thinking-event-fields]
    [(stream-message-start-event) stream-message-start-event-fields]
    [(stream-message-delta-event) stream-message-delta-event-fields]
    [(stream-message-end-event) stream-message-end-event-fields]
    [(stream-turn-completed-event) stream-turn-completed-event-fields]
    [(stream-turn-cancelled-event) stream-turn-cancelled-event-fields]
    [(stream-tool-call-started-event) stream-tool-call-started-event-fields]
    [(stream-assistant-msg-completed-event) stream-assistant-msg-completed-event-fields]
    [else '()]))
