...
### Audit Remediation (v0.22.5 Post-Merge Fixes)
...
- **AUDIT-10**: Verified shell-quote direct import fix (already done in v0.22.5)
...
- **DOC-02**: Updated releasing.md verified-against to v0.22.5
...
- **Updated**: All verified-against markers to v0.22.5
...
**Wave 3 — Version bump 0.22.5 → 0.22.5** (PR #1663)
...
**Wave 3 — Version bump 0.22.5 → 0.22.5** (PR #1660)
- Version bump and CHANGELOG update
...
Milestone #92 — Post-v0.22.5 review follow-ups and planning prompt augmentation.
...
- Synced all version surfaces: info.rkt, README.md, docs/*.md, wiki-src/ to 0.22.5.
...
registration fixes from v0.22.5 review.
...
Security and robustness fixes from comprehensive audit of v0.22.5–v0.22.5
...
### Critical Fixes (from PROJECT_REVIEW_v0.22.5)
...
- Bump version references across all docs to 0.22.5
...
`.planning/REVIEW-v0.22.5.md` (73 findings: 6 CRITICAL, 23 MAJOR, 32 MINOR, 12 NIT).
...
- **Wave 11**: Fixed README v0.22.5 status block — replaced v0.13.x description with accurate v0.22.5 features (D1). Synced metrics (D2)
