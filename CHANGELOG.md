...
- **VER**: Architecture fitness test for line count (<600); version bump to 0.25.0
...
- **VER**: Version bump to 0.25.0, security docs updated
...
**Housekeeping**
- Synced version references from 0.25.0 to 0.25.0 (VER-01)
...
**Goal**: Make CI green whenever local pre-commit passes. Addresses v0.25.0
...
**W4** — arch-report.rkt script (CI gate), version bump 0.25.0 → 0.25.0.
...
### Audit Remediation (v0.25.0 Post-Merge Fixes)
...
- **AUDIT-10**: Verified shell-quote direct import fix (already done in v0.25.0)
...
- **DOC-02**: Updated releasing.md verified-against to v0.25.0
...
- **Updated**: All verified-against markers to v0.25.0
...
**Wave 3 — Version bump 0.25.0 → 0.25.0** (PR #1663)
...
**Wave 3 — Version bump 0.25.0 → 0.25.0** (PR #1660)
- Version bump and CHANGELOG update
...
Milestone #92 — Post-v0.25.0 review follow-ups and planning prompt augmentation.
...
- Synced all version surfaces: info.rkt, README.md, docs/*.md, wiki-src/ to 0.25.0.
...
registration fixes from v0.25.0 review.
...
Security and robustness fixes from comprehensive audit of v0.25.0–v0.25.0
...
### Critical Fixes (from PROJECT_REVIEW_v0.25.0)
...
- Bump version references across all docs to 0.25.0
...
`.planning/REVIEW-v0.25.0.md` (73 findings: 6 CRITICAL, 23 MAJOR, 32 MINOR, 12 NIT).
...
- **Wave 11**: Fixed README v0.25.0 status block — replaced v0.13.x description with accurate v0.25.0 features (D1). Synced metrics (D2)
