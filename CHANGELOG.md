...
- **VER**: Architecture fitness test for line count (<600); version bump to 0.24.9
...
- **VER**: Version bump to 0.24.9, security docs updated
...
**Housekeeping**
- Synced version references from 0.24.9 to 0.24.9 (VER-01)
...
- **F3: Shim Purification** — Removed behavioral logic from `gsd-planning-state.rkt`
  ...
  (deprecated, removal planned for v0.24.9).
...
**Goal**: Make CI green whenever local pre-commit passes. Addresses v0.24.9
...
**W4** — arch-report.rkt script (CI gate), version bump 0.24.9 → 0.24.9.
...
### Audit Remediation (v0.24.9 Post-Merge Fixes)
...
- **AUDIT-10**: Verified shell-quote direct import fix (already done in v0.24.9)
...
- **DOC-02**: Updated releasing.md verified-against to v0.24.9
...
- **Updated**: All verified-against markers to v0.24.9
...
**Wave 3 — Version bump 0.24.9 → 0.24.9** (PR #1663)
...
**Wave 3 — Version bump 0.24.9 → 0.24.9** (PR #1660)
- Version bump and CHANGELOG update
...
Milestone #92 — Post-v0.24.9 review follow-ups and planning prompt augmentation.
...
- Synced all version surfaces: info.rkt, README.md, docs/*.md, wiki-src/ to 0.24.9.
...
registration fixes from v0.24.9 review.
...
Security and robustness fixes from comprehensive audit of v0.24.9–v0.24.9
...
### Critical Fixes (from PROJECT_REVIEW_v0.24.9)
...
- Bump version references across all docs to 0.24.9
...
`.planning/REVIEW-v0.24.9.md` (73 findings: 6 CRITICAL, 23 MAJOR, 32 MINOR, 12 NIT).
...
- **Wave 11**: Fixed README v0.24.9 status block — replaced v0.13.x description with accurate v0.24.9 features (D1). Synced metrics (D2)
