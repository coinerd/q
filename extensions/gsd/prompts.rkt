...
(define (planning-prompt user-request)
  (string-append "# GSD Planning Phase — Write-Immediately Workflow\n\n"
                 ...
                 "Read ONLY the primary file(s) mentioned in the request.\n"
                 ...
                 "## Files\n"
                 "- File: q/path/to/file.rkt\n"
                 "- File: q/path/to/other.rkt\n\n"
                 "## Action\n"
                 "<what to do, include old-text/new-text for edits>\n\n"
                 "## Verify\n"
                 "raco test q/tests/test-foo.rkt\n\n"
                 "## Done\n"
                 "- <completion criteria>\n"
                 "```\n\n"
