...
[![Version](https://img.shields.io/badge/version-0.17.9-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.17.9
...
├── tests/          Full test suite (366 files)
