...
[![Version](https://img.shields.io/badge/version-0.99.60-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.99.60
...
├── tests/          Full test suite (1191 files)
