...
[![Version](https://img.shields.io/badge/version-0.73.6-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.73.6
...
├── tests/          Full test suite (731 files)
