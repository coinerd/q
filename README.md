...
[![Version](https://img.shields.io/badge/version-0.29.13-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.29.13
...
├── tests/          Full test suite (511 files)
