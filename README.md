...
[![Version](https://img.shields.io/badge/version-0.69.4-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.69.4
...
├── tests/          Full test suite (699 files)
...
**v0.69.4** — Abstraction Quality: Representation Discipline
