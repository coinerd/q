...
[![Version](https://img.shields.io/badge/version-0.5.2-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version   # q version 0.5.2
...
| Source lines | 17112 |
| Test lines | 28045 |
| Test assertions | 4817 |
| `raco test` results | 2,924 tests passing |
...
**v0.5.2** — Extension Platform Stabilization. Tiered capabilities, test harness:
