...
[![Version](https://img.shields.io/badge/version-0.65.0-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.65.0
...
├── tests/          Full test suite (682 files)
