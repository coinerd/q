...
[![Version](https://img.shields.io/badge/version-0.28.21-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.28.21
...
├── tests/          Full test suite (481 files)
...
**v0.28.21** — Audit Remediation. Fix `translate-stop-reason` arity in test-anthropic/gemini (14 calls), correct inaccurate CHANGELOG/README claims, fix 429 test expectation.
