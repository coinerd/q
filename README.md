...
[![Version](https://img.shields.io/badge/version-0.71.7-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.71.7
...
├── tests/          Full test suite (711 files)
