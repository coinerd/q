...
[![Version](https://img.shields.io/badge/version-0.4.2-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version   # q version 0.4.2
...
**v0.4.2** — Active development. All core features implemented and tested:
