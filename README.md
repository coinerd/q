...
[![Version](https://img.shields.io/badge/version-0.6.5-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version   # q version 0.6.5
...
| Source lines | 19882 |
| Test lines | 31123 |
| Test assertions | 5312 |
| `raco test` results | 3,067 tests passing |
