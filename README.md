...
[![Version](https://img.shields.io/badge/version-0.40.5-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.40.5
...
├── tests/          Full test suite (572 files)
