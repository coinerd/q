...
[![Version](https://img.shields.io/badge/version-0.69.7-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.69.7
...
**v0.69.7** — GUI Bugfix + Audit Closure
