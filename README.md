...
[![Version](https://img.shields.io/badge/version-0.77.10-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.77.10
...
├── tests/          Full test suite (763 files)
...
**v0.74.6** — Core Loop Tests: Pure Functions (T-1a)

**v0.74.5** — Core Loop Tests: Pure Functions (T-1a)

**v0.74.4** — Core Loop Tests: Pure Functions (T-1a)

**v0.74.3** — Core Loop Tests: Pure Functions (T-1a)

**v0.74.2** — Core Loop Tests: Pure Functions (T-1a)

**v0.74.1** — Core Loop Tests: Pure Functions (T-1a)

**v0.74.0** — Core Loop Tests: Pure Functions (T-1a)
...
**v0.73.5** — Core Loop Tests: Pure Functions (T-1a)

**v0.73.4** — Core Loop Tests: Pure Functions (T-1a)

**v0.73.3** — Core Loop Tests: Pure Functions (T-1a)

**v0.73.2** — Core Loop Tests: Pure Functions (T-1a)
...
**v0.71.8** — Agent Evaluator + Series Audit

**v0.71.7** — Agent Evaluator + Series Audit

**v0.71.6** — Agent Evaluator + Series Audit

**v0.71.5** — GUI Integration + Release Polish

**v0.71.4** — TUI Integration & Status Display

**v0.71.3** — Deterministic Checks

**v0.71.2** — Evidence Discipline + No-Progress Detection

**v0.71.1** — Transcript Evaluator + Core Loop

**v0.71.0** — Goal State & Event Foundation

**v0.70.13** — Audit Hotfix Round 3 + GUI Bug Fixes

**v0.70.12** — Audit Hotfix Round 2 — Closure of v0.70.11 Audit Findings

**v0.70.11** — Post-Audit Hotfix — Critical/Warning Finding Remediation

**v0.70.10** — Series Stabilization + Post-Series Audit

**v0.70.9** — Typed Racket Gradual Migration — Boundary Pilot

**v0.70.8** — Large Test File Decomposition

**v0.70.7** — Per-Tool Timeout Override

**v0.70.6** — Token Estimation Memoization

**v0.70.5** — Opt-In Async Session/Event Sink Pilot

**v0.70.4** — Async Trace/Event Logging

**v0.70.3** — Structured Shell Risk Classification

**v0.70.2** — Cross-Platform Credential Backends + Windows Install

**v0.70.1** — Credential Policy & Plaintext Fallback Warnings

**v0.70.0** — Audit Baselines & Risk Harnesses

**v0.69.7** — Audit Followups

**v0.69.6** — GUI Bugfix + Audit Closure
...
**v0.69.2** — Abstraction Quality: Missing Domain Functions

**v0.69.1** — Abstraction Quality: Dead Code, Dedup, Immutability

**v0.69.0** — GUI Critical Hotfix

**v0.68.7** — GUI Critical Hotfix

**v0.68.6** — GUI Hardening

**v0.68.5** — GUI Critical Fix + text% Render Tree

**v0.68.4** — GUI Audit Remediation

**v0.68.3** — Keyboard Shortcuts + Polish

**v0.68.2** — Code Blocks + Multiline Input

**v0.68.1** — Streaming Performance

**v0.68.0** — Rich Transcript Core
...
**v0.66.0** — Advanced Features (Sidebar, Toolbar, Themes)

**v0.65.0** — Extension Integration + Dialogs

**v0.64.0** — Core Views (Transcript, Input, Status)

**v0.63.0** — Infrastructure + Observable Bridge

**v0.62.3** — Audit Findings Remediation

**v0.62.2** — HTML Render Backend + Architecture Validation

**v0.62.1** — Key Dispatch Through Components

**v0.62.0** — Component Lifecycle & State in Production

**v0.61.8** — Native TUI Final Cleanup

**v0.61.7** — Native TUI Final — Architecture Polish & Documentation

**v0.61.6** — Native TUI M4 — Remove Legacy Path + Final Cleanup

**v0.61.5** — Native TUI M4 — Remove Legacy Path + Final Cleanup

**v0.61.4** — Native TUI M4 — Remove Legacy Path + Final Cleanup

**v0.61.3** — Native TUI M4 — Remove Legacy Path + Final Cleanup

**v0.61.2** — Native TUI M4 — Remove Legacy Path + Final Cleanup

**v0.61.1** — Native TUI M2 — Production VDOM Components

**v0.61.0** — Native TUI M1 — VDOM Render Path + Parity Tests

**v0.60.6** — Native TUI Bugfix — Snapshot Crash + cmd-ctx Arity + Auto-wrap Glitch

**v0.60.5** — Native TUI Cleanup and Documentation

**v0.60.4** — Security/Workflow Enforcement Closure

**v0.60.3** — Security/Workflow Enforcement Closure

**v0.60.2** — Security/Workflow Enforcement Closure

**v0.60.1** — Security/Workflow Enforcement Closure

**v0.60.0** — Security/Workflow Enforcement Closure
