...
[![Version](https://img.shields.io/badge/version-0.39.11-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.39.11
...
├── tests/          Full test suite (567 files)
