...
[![Version](https://img.shields.io/badge/version-0.35.6-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.35.6
...
├── tests/          Full test suite (548 files)
