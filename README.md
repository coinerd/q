...
[![Version](https://img.shields.io/badge/version-0.31.12-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.31.12
...
├── tests/          Full test suite (523 files)
