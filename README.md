...
[![Version](https://img.shields.io/badge/version-0.20.2-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.20.2
...
├── tests/          Full test suite (416 files)
