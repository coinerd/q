...
[![Version](https://img.shields.io/badge/version-0.99.46-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.99.46
...
├── tests/          Full test suite (1143 files)
