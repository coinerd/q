...
[![Version](https://img.shields.io/badge/version-0.29.17-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.29.17
...
├── tests/          Full test suite (514 files)
