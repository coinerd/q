...
[![Version](https://img.shields.io/badge/version-0.6.6-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version   # q version 0.6.6
...
| Source lines | 20005 |
| Test lines | 31468 |
| Test assertions | 5365 |
| `raco test` results | 3,152 tests passing |
