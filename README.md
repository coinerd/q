...
[![Version](https://img.shields.io/badge/version-0.32.5-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.32.5
...
├── tests/          Full test suite (525 files)
...
**v0.32.5** — Architecture Abstraction Roadmap Remediation (v0.31.13-W0)
