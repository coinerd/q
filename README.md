...
[![Version](https://img.shields.io/badge/version-0.47.13-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.47.13
...
├── tests/          Full test suite (606 files)
...
**v0.47.13** — v0.47.x Series Summary (Abstraction Remediation)
