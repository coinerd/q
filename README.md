...
[![Version](https://img.shields.io/badge/version-0.99.27-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.99.27
...
├── tests/          Full test suite (1065 files)
