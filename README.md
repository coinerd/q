...
[![Version](https://img.shields.io/badge/version-0.44.4-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.44.4
...
├── tests/          Full test suite (584 files)
