...
[![Version](https://img.shields.io/badge/version-0.63.0-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.63.0
...
├── tests/          Full test suite (673 files)
