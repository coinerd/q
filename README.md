...
[![Version](https://img.shields.io/badge/version-0.37.2-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.37.2
...
**v0.37.2** — Goal: Registry Encapsulation + Concurrency (Milestone 2 of v0.37.x)

**v0.37.2** — Goal: Audit Remediation — Comment Cleanup + Import + Test Optimization
