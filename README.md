...
[![Version](https://img.shields.io/badge/version-0.46.1-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.46.1
...
├── tests/          Full test suite (588 files)
