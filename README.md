...
[![Version](https://img.shields.io/badge/version-0.32.6-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.32.6
...
├── tests/          Full test suite (526 files)
...
**v0.32.6** — Architecture Abstraction Roadmap Remediation (v0.31.13-W0)
