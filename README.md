...
[![Version](https://img.shields.io/badge/version-0.78.6-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.78.6
...
├── tests/          Full test suite (764 files)
