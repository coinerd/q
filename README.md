...
[![Version](https://img.shields.io/badge/version-0.62.3-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.62.3
...
├── tests/          Full test suite (667 files)
