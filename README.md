...
[![Version](https://img.shields.io/badge/version-0.60.3-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.60.3
...
├── tests/          Full test suite (661 files)
