...
[![Version](https://img.shields.io/badge/version-0.19.8-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.19.8
...
├── tests/          Full test suite (398 files)
