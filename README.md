...
[![Version](https://img.shields.io/badge/version-0.30.14-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.30.14
...
├── tests/          Full test suite (516 files)
