...
[![Version](https://img.shields.io/badge/version-0.34.2-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.34.2
...
├── tests/          Full test suite (533 files)
