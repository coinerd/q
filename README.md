...
[![Version](https://img.shields.io/badge/version-0.99.65-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.99.65
...
├── tests/          Full test suite (1193 files)
