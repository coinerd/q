...
[![Version](https://img.shields.io/badge/version-0.46.6-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.46.6
...
├── tests/          Full test suite (598 files)
