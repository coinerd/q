...
[![Version](https://img.shields.io/badge/version-0.99.52-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.99.52
...
├── tests/          Full test suite (1188 files)
