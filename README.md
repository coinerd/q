...
[![Version](https://img.shields.io/badge/version-0.46.2-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.46.2
...
├── tests/          Full test suite (589 files)
