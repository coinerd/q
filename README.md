...
[![Version](https://img.shields.io/badge/version-0.70.7-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.70.7
...
├── tests/          Full test suite (702 files)
