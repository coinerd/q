...
[![Version](https://img.shields.io/badge/version-0.75.5-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.75.5
...
├── tests/          Full test suite (739 files)
