...
[![Version](https://img.shields.io/badge/version-0.53.11-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.53.11
...
├── tests/          Full test suite (608 files)
