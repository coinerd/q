...
[![Version](https://img.shields.io/badge/version-0.6.0-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version   # q version 0.6.0
...
| Source lines | 18395 |
| Test lines | 29326 |
| Test assertions | 5002 |
| `raco test` results | 3,043 tests passing |
...
**v0.6.0** — Trust & Safety. Package audit, safe mode, extension quarantine:
