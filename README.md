...
[![Version](https://img.shields.io/badge/version-0.99.84-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.99.84
...
├── tests/          Full test suite (1274 files)
