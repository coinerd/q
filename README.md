...
[![Version](https://img.shields.io/badge/version-0.45.10-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.45.10
...
├── tests/          Full test suite (586 files)
