...
[![Version](https://img.shields.io/badge/version-0.75.8-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.75.8
...
├── tests/          Full test suite (750 files)
