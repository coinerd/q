...
[![Version](https://img.shields.io/badge/version-0.39.9-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.39.9
...
├── tests/          Full test suite (565 files)
