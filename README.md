...
[![Version](https://img.shields.io/badge/version-0.99.50-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.99.50
...
├── tests/          Full test suite (1156 files)
