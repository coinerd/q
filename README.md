...
[![Version](https://img.shields.io/badge/version-1.00.31-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 1.00.31
...
├── tests/          Full test suite (1512 files)
...
**v1.00.31** — Wave-delivery integrity: PERMANENT over the frozen 13-row register; v1.00.30 W4 DELIVERED
...
**v0.99.99** — Added — Shared UI semantic layer
...
**v0.99.77** — Agent Harness Reliability (W0-W3)

**v0.99.76** — Security (Phase 1: Security Critical)
...
**v0.99.52** — Build-once release pipeline and milestone closure
