...
[![Version](https://img.shields.io/badge/version-0.99.69-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.99.69
...
├── tests/          Full test suite (1227 files)
