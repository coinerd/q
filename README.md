...
[![Version](https://img.shields.io/badge/version-0.68.5-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.68.5
...
├── tests/          Full test suite (693 files)
