...
[![Version](https://img.shields.io/badge/version-0.99.68-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.99.68
...
├── tests/          Full test suite (1226 files)
