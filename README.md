...
[![Version](https://img.shields.io/badge/version-0.99.15-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.99.15
...
├── tests/          Full test suite (1033 files)
