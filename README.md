...
[![Version](https://img.shields.io/badge/version-0.10.1-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.10.1
...
| Source lines | 26720 |
| Test lines | 45110 |
| Test assertions | 7402 |
| `raco test` results | 3,399 tests passing |
...
**v0.10.1** — TUI Component System & Overlay Composition. Component-based rendering with per-zone caching, overlay composition framework for command palette, token-aware context assembly pipeline, test infrastructure cleanup, 3750+ tests.
