...
[![Version](https://img.shields.io/badge/version-0.35.0-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.35.0
...
├── tests/          Full test suite (537 files)
