...
[![Version](https://img.shields.io/badge/version-0.99.67-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.99.67
...
├── tests/          Full test suite (1225 files)
