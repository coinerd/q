...
[![Version](https://img.shields.io/badge/version-0.7.2-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version   # q version 0.7.2
...
| Source lines | 20266 |
| Test lines | 32386 |
| Test assertions | 5485 |
| `raco test` results | 3,040 tests passing |
...
**v0.7.2** — Builder Cookbook and Team Adoption. Team setup guide, builder tutorials for custom tools/providers/extensions:
