...
[![Version](https://img.shields.io/badge/version-0.60.6-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.60.6
...
├── tests/          Full test suite (663 files)
