...
[![Version](https://img.shields.io/badge/version-0.5.0-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version   # q version 0.5.0
...
**v0.5.0** — Active development. All core features implemented and tested:
