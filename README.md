...
[![Version](https://img.shields.io/badge/version-0.14.3-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.14.3
...
├── tests/          Full test suite (336 files)
