...
[![Version](https://img.shields.io/badge/version-0.15.2-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.15.2
...
├── tests/          Full test suite (348 files)
