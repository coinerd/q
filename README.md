...
[![Version](https://img.shields.io/badge/version-0.37.1-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.37.1
...
├── tests/          Full test suite (552 files)
...
**v0.37.1** — Goal: Registry Encapsulation + Concurrency (Milestone 2 of v0.37.x)

**v0.37.1** — Goal: Audit Remediation — Comment Cleanup + Import + Test Optimization
