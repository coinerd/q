...
[![Version](https://img.shields.io/badge/version-0.54.7-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.54.7
...
├── tests/          Full test suite (617 files)
