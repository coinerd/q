...
[![Version](https://img.shields.io/badge/version-0.66.0-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.66.0
...
├── tests/          Full test suite (686 files)
