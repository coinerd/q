...
[![Version](https://img.shields.io/badge/version-0.14.0-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.14.0
...
├── tests/          Full test suite (329 files)
...
**v0.14.0** — Remove Context Reduction from Retry. Retries always use same context (no trimming). TUI transcript O(1) append. Pair-aware context reducer, prompt pinning, progressive timeout, newline bleed fix, settings contract fix. 5330+ tests.
