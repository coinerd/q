...
[![Version](https://img.shields.io/badge/version-0.99.66-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.99.66
...
├── tests/          Full test suite (1218 files)
