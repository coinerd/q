...
[![Version](https://img.shields.io/badge/version-0.6.1-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version   # q version 0.6.1
...
| Source lines | 18483 |
| Test lines | 29871 |
| Test assertions | 5062 |
| `raco test` results | 2,975 tests passing |
...
**v0.6.1** — Security Hardening. Wire safe-mode/quarantine into enforcement, path validation, API key protection, env sanitization, test isolation:

**Previous** — Trust & Safety. Package audit, safe mode, extension quarantine:
