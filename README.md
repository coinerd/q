...
[![Version](https://img.shields.io/badge/version-0.5.3-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version   # q version 0.5.3
...
| Source lines | 17881 |
| Test lines | 28809 |
| Test assertions | 4931 |
| `raco test` results | 2,991 tests passing |
...
**v0.5.3** — Session Artifacts & Replay. Export, inspect, replay:
