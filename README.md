...
[![Version](https://img.shields.io/badge/version-0.99.94-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.99.94
...
├── tests/          Full test suite (1314 files)
