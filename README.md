...
[![Version](https://img.shields.io/badge/version-0.22.5-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.22.5
...
├── tests/          Full test suite (434 files)
