...
[![Version](https://img.shields.io/badge/version-0.28.26-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.28.26
...
├── tests/          Full test suite (485 files)
