...
[![Version](https://img.shields.io/badge/version-0.99.87-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.99.87
...
├── tests/          Full test suite (1277 files)
