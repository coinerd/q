...
[![Version](https://img.shields.io/badge/version-0.61.2-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.61.2
...
├── tests/          Full test suite (666 files)
...
**v0.61.2** — Native TUI M3 — Cell-Diff Batch Optimization + Benchmarking
