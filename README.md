...
[![Version](https://img.shields.io/badge/version-0.7.1-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version   # q version 0.7.1
...
| Source lines | 20083 |
| Test lines | 32119 |
| Test assertions | 5398 |
| `raco test` results | 3,009 tests passing |
...
**v0.7.1** — Builder Cookbook and Team Adoption. Team setup guide, builder tutorials for custom tools/providers/extensions:
