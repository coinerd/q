...
[![Version](https://img.shields.io/badge/version-0.32.9-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.32.9
...
├── tests/          Full test suite (530 files)
