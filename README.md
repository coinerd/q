...
[![Version](https://img.shields.io/badge/version-0.29.7-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.29.7
...
├── tests/          Full test suite (505 files)
