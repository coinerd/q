...
[![Version](https://img.shields.io/badge/version-0.55.10-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.55.10
...
├── tests/          Full test suite (622 files)
