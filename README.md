...
[![Version](https://img.shields.io/badge/version-0.41.1-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.41.1
...
├── tests/          Full test suite (576 files)
