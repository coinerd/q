...
[![Version](https://img.shields.io/badge/version-0.29.0-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.29.0
...
├── tests/          Full test suite (490 files)
