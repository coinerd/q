...
[![Version](https://img.shields.io/badge/version-0.99.10-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.99.10
...
├── tests/          Full test suite (971 files)
