...
[![Version](https://img.shields.io/badge/version-0.37.6-blue.svg)](https://github.com/coinerd/q)
...
```bash
racket main.rkt --version  # q version 0.37.6
...
**v0.37.6** — Goal: Turn Orchestrator Decomposition (Milestone 6 of v0.37.x)

**v0.37.6** — Goal: Audit Remediation — Comment Cleanup + Import + Test Optimization
