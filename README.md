...
[![Version](https://img.shields.io/badge/version-0.50.5-blue.svg)](https://github.com/coinerd/q)
...
```bash
bin/q --version            # q version 0.50.5
...
├── tests/          Full test suite (607 files)
