<!-- verified-against: 0.29.17 --># Security Considerations
...
## Command Execution Policy (v0.29.17 — updated from v0.25.3 baseline)
...
## Environment Variable Scrubbing (v0.29.17 — updated from v0.25.3 baseline)
