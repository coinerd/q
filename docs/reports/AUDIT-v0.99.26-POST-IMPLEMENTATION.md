...
## Errata (v0.99.27 W4 — Audit Finding B-3)

**Date:** 2026-07-20
**Finding:** The original §6 Note #2 above characterized the fast-suite
timeout as benign and "consistent with prior milestones." The in-depth audit
(AUDIT-v0.99.26-IN-DEPTH.md, finding B-3) determined this characterization
was **not fully truthful**: the broad gate was never completed, and the audit
claimed "PASS" without the fast suite actually running to completion.

**Correction:**

- The broad fast suite (`racket scripts/run-tests.rkt --suite fast`) does NOT
  complete within the 600s environment timeout. This is an **environmental
  limitation**, not evidence of a passing suite.
- The correct classification is: **broad gate = NOT RUN TO COMPLETION**.
- Focused tests (§4) remain valid and do pass.
- The v0.99.27 W4 triage report (`AUDIT-v0.99.27-BROAD-GATE-TRIAGE.md`)
  provides the detailed classification of individual failures.

No other conclusions in this audit are affected by this errata.

---

*Audit generated by W6 (#8255). Errata added by v0.99.27 W4 (#8271).*
