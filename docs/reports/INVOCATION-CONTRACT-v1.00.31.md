...
| `README.md` metrics | 187669 src lines | **188384 / 892 / 1504 / 277327 / 41971** | canonical `scripts/metrics.rkt --sync-all`; `--lint` ⇒ 5/5. The resync ran twice: 277204 → 277303 with the F1 fix round, then → 277327 when the git-fixture guard added test lines (a required `metrics-sync` check, so it could not be left stale) |
