...
and v0.99.92 (6). Wave IDs, order, goals, scope, gates, and acceptance become
...
| MA-10 | OPEN | Runtime session lifecycle | .92 W0–W5 | 600-LOC baseline + reassessment | trace-equivalent extraction measurably improves locality, or evidence-backed rejection | v0.99.92 |
...
| v0.99.92 Lifecycle/Series Closure (#879; #9242–#9247) | W0–W5 (6) | W2, W5 | MA-10; guards MA-11/12 | reassessment, 100% final traceability, zero stale tracking, verified release |
