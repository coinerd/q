#hasheq(
 ...
 (content-digest . "487fa5fc9048b1dce003887158a60899bb48ebdb047e787d84c3037d675337e4")
...
(suites
 ...
 (notes
  . "This record is written at the W7 content head 2428611c392f0feec595c3e881beb88536ca52c6. Every number above was measured at the head named in head-coherence and retained as a raw capture; none is invented. Four independent review rounds have completed and all four returned CHANGES-REQUESTED, with all eighteen findings reproduced against the tree before being fixed. Round 4 found no new defect in the W7 content itself: its six findings were three more instances of the claim-versus-evidence class in the artifacts the earlier rounds had produced, one schema-convention warning accepted with its reason, and one prose error. A fifth round is outstanding, so the wave is not merge-authorized: the readiness gate, the seven-gate tag-publish preflight, the merge itself, and the v1.00.31 tag all remain ahead, in that order."))
