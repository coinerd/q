...
(suites
 ...
 (notes
  . "This record is written at the W7 content head 86002515f9de49d4abd83d83fd279656ab7c15e7. Every number above was measured at the head named in head-coherence and retained as a raw capture; none is invented. Three independent review rounds have completed and all three returned CHANGES-REQUESTED, with all twelve findings reproduced against the tree and fixed. A fourth round is outstanding, so the wave is not merge-authorized: the readiness gate, the seven-gate tag-publish preflight, the merge itself, and the v1.00.31 tag all remain ahead, in that order."))
