...
**Baseline version:** `q version 0.59.1`
...
| `racket main.rkt --version` | 0 | `q version 0.59.1` |
...
- tag `v0.59.1` does not exist yet — PASS in current pre-release semantics
- `CHANGELOG missing entry for 0.59.1` — false negative because changelog uses `## v0.59.1`
