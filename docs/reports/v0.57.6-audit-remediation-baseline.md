...
**Baseline version:** `q version 0.59.2`
...
| `racket main.rkt --version` | 0 | `q version 0.59.2` |
...
- tag `v0.59.2` does not exist yet — PASS in current pre-release semantics
- `CHANGELOG missing entry for 0.59.2` — false negative because changelog uses `## v0.59.2`
