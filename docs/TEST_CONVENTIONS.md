...
gaps. Enforcement was scheduled for v1.00.23 but flipped to blocking one
release later, in **v1.00.23**: the report-only inventory run at that point
...
v1.00.23 milestone slipping was deliberate, not silent — it waited on the
