...
(define resolved (resolve-version index "my-extension" "0.22.1"))(unless resolved
...
|-------|----------|--------|---------|
| `compat` | `qpm.json` | Semver range | `">=0.22.1 <1.0.0"` |
| `min-q-version` | `index.json` | SemVer | `"0.22.1"` || `max-q-version` | `index.json` | SemVer (exclusive) | `"1.0.0"` |
