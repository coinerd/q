...
|-------|------|---------|-------------|
| `compat` | `string` | `null` | SemVer range for q compatibility (e.g. `">=0.24.9"`) || `files` | `string[]` | `[]` | List of files included in the package |
...
| Example | Meaning |
|---------|---------|
| `">=0.24.9"` | q 0.24.9 or later |
| `">=0.24.9 <1.0.0"` | q 0.10.x only |
| `"^0.24.9"` | Compatible with 0.24.9 (semver caret) |
| `"~0.24.9"` | Patch-level changes only (0.10.x) |
...
```json
{
  "name": "my-extension",
  "version": "1.0.0",
  "min-q-version": "0.24.9",  "max-q-version": "1.0.0",
  "description": "...",
  "author": "...",
