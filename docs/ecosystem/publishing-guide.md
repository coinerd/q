...
|-------|------|---------|-------------|
| `compat` | `string` | `null` | SemVer range for q compatibility (e.g. `">=0.24.4"`) || `files` | `string[]` | `[]` | List of files included in the package |
...
| Example | Meaning |
|---------|---------|
| `">=0.24.4"` | q 0.24.4 or later |
| `">=0.24.4 <1.0.0"` | q 0.10.x only |
| `"^0.24.4"` | Compatible with 0.24.4 (semver caret) |
| `"~0.24.4"` | Patch-level changes only (0.10.x) |
...
```json
{
  "name": "my-extension",
  "version": "1.0.0",
  "min-q-version": "0.24.4",  "max-q-version": "1.0.0",
  "description": "...",
  "author": "...",
