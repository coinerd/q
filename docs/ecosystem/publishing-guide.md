...
|-------|------|---------|-------------|
| `compat` | `string` | `null` | SemVer range for q compatibility (e.g. `">=0.23.2"`) || `files` | `string[]` | `[]` | List of files included in the package |
...
| Example | Meaning |
|---------|---------|
| `">=0.23.2"` | q 0.23.2 or later |
| `">=0.23.2 <1.0.0"` | q 0.10.x only |
| `"^0.23.2"` | Compatible with 0.23.2 (semver caret) |
| `"~0.23.2"` | Patch-level changes only (0.10.x) |
...
```json
{
  "name": "my-extension",
  "version": "1.0.0",
  "min-q-version": "0.23.2",  "max-q-version": "1.0.0",
  "description": "...",
  "author": "...",
