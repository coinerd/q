<!-- verified-against: 0.99.12 -->
# Distributed Execution Guide

This guide covers q's **opt-in** distributed execution feature (v0.99.12, MAS Schritt 6 Phase 2). High-risk tool execution can be routed to a remote executor node over mTLS-secured TCP, isolating hostile code from the developer machine.
