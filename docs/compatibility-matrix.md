...
|-----------|--------------|-----------|----------|
| 0.22.1+ | `0.7` | No | Additive — permission gates, hot-reload hooks |
| 0.22.1+ | `0.6` | No | Additive — extension subdirectories, execute-command hook, catalog API |
| 0.22.1+ | `0.22.1` | No | Additive — `dangerous?` tool field, one-shot safe-mode |
| 0.22.1+ | `0.5` | No | Additive — safe-mode hooks, quarantine |
| 0.22.1+ | `0.4` | No | Additive — session-tree hooks |
| 0.22.1+ | `0.3` | No | Additive — new hook types |
| 0.22.1+ | `0.2` | No | Additive — extension context fields |
| 0.22.1+ | `0.1` | Yes | Changed `extension` struct to 4-arg |

## Provider Compatibility

| Provider | Min q Version | Status |
|----------|--------------|--------|
| OpenAI-compatible | 0.22.1 | Stable |
| Anthropic (Claude) | 0.22.1 | Stable |
| Gemini | 0.22.1 | Stable |
| Local (llama.cpp server) | 0.22.1 | Stable |
