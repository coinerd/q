...
|---|---|---|---|---|---|---|
| W0 | 🟡 source-anchored trace oracle 6 tests drafted | PENDING | six path families, 10 units, 19 exceptional exits, parameter/save-back timing | — | PENDING | IN PROGRESS |
