 ...
 (candidates .
  (#hasheq((id . busy-error-construction)
   ...
   #hasheq((id . acknowledgement-tracer)
           ...
           (params . 5)
           (unique-imports . 0)
           (rationale . "One third of the terminal-identity decision (W0-F2); fragmentation without fan-out gain.")
           (anchor . "runtime/session/session-lifecycle.rkt:acknowledgement-tracer"))
   #hasheq((id . cleanup-turn-completed)
           (verdict . reject)
           (lines . 17)
           (params . 2)
           (unique-imports . 0)
           (rationale . "Order-critical safety-net terminal glued to the box protocol; no fan-out gain.")
           (anchor . "runtime/session/session-lifecycle.rkt:emit-cleanup-turn-completed?"))
