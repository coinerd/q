...
(provide (all-from-out "session-index/schema.rkt")
         (contract-out [build-index! (-> path-string? path-string? session-index?)]
                       ...
                       [branch! (-> session-index? string? any/c)]
                       [branch-with-summary! (-> session-index? string? string? any/c)]
                       ...
                       [lookup-entry (-> session-index? string? any/c)]
                       [children-of (-> session-index? string? list?)]
                       [leaf-nodes (-> session-index? list?)]
                       [resolve-active-leaf (-> session-index? any/c)]
                       [active-leaf (-> session-index? any/c)]
