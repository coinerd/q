...
;; util/iteration/fsm-types.rkt — Iteration FSM state/event types (R-06, R-07)
;; STABILITY: evolving
;;
;; SHARED PROTOCOL: Iteration FSM definitions. These types form the
...
;; these shared protocol types neutral ownership.
;;
