...
;;   resource-set        — struct for a loaded collection of resources
;;   empty-resource-set  — constructor for an empty set
;;   load-global-resources   — scan a global base directory
;;   load-project-resources  — scan a project directory (.q/ or .pi/)
;;   merge-resources     — merge global + project with correct precedence
;;   render-template     — substitute {{var}} placeholders in a template
